...
<link rel="stylesheet" href="<%=basePath%>css/cropper.min.css">
<link rel="stylesheet" href="<%=basePath%>css/ImgCropping.css">
<!-- Bootstrap Core CSS -->
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="row">
					<!-- 修改头像 -->
					<h3 class="title1">修改头像 :</h3>

					<form align="center" action="<%=basePath%>teacher/uploadAva"
						method="post" role="form" enctype="multipart/form-data">
						<div class="col-sm-6 col-md-3">
							<div class="thumbnail">
								<h3>当前头像</h3>
								<br> <img src="<%=basePath %>${sessionScope.teacher.avatar }" alt="暂无头像">
							</div>
						</div>

						<div class="form-group">
							<label for="avatar" class="col-sm-2 control-label">更换头像:</label>
							<div class="col-sm-4">
								<input type="file" class="form-control" id="avatar"
									placeholder="请选择头像" name="avatar"> <br>
							</div>
						</div>
