	...
	<div class="main-content">
		...
		<div class=" sidebar" role="navigation">
			<div class="navbar-collapse">
				...
				<ul class="nav" id="side-menu">
					<li><a href="teacherPersonCen.jsp" class="active"><i
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="row">
					<!-- 学生下载作业 -->
					<h3 class="title1">老师下载作业 :</h3>
					<div class="form-three widget-shadow">
						<form class="form-horizontal" method="post" role="form"
							action="<%=basePath %>teacher/listAllFiles2">
							<!-- 下载作业班级号 -->
							<div class="form-group">
								<label for="classId" class="col-sm-2 control-label">请输入您的班级号:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control1" name="classId"
										id="classId" placeholder="请输入下载作业的班级号...">
