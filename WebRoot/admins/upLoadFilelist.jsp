...
<body>
	...
	<div class="container-fluid">
        ...
        <li><a href="#">浏览帖子</a></li>
        <li><a href="<%=basePath %>admin/listAllFileG2">下载公共资源</a></li>
        <li class="active"><a href="<%=basePath %>admins/upLoadFilelist.jsp">上传公共资源</a></li>
	...
	<div class="container">
		...
		<form class="form-inline" method="post" role="form"
							action="<%=basePath %>admin/uploadFile" enctype="multipart/form-data">
							<!-- 上传资源 -->
